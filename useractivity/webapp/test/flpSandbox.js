		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flp useractivity",
									"targetURL": "#comlbuseractivity-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlbuseractivity-display": {
								"semanticObject": "comlbuseractivity",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lb.useractivity",
									"url": sap.ui.require.toUrl("com/lb/useractivity")
								}
							}
						}
					}
